...
public class ActivityEditHoaDonNhap extends AppCompatActivity {
    ...
    private void eventDialog() {
        ...
        ed_editdongiaHD_nhap.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        ed_editsoluongHD_nhap.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
                ...
                if (check()) {
                    ...
                    if (kq > 0) {
                        ...
                        if (kqCT > 0) {
                            ...
                            Toast.makeText(getApplicationContext(), "Sửa hóa đơn thành công", Toast.LENGTH_SHORT).show();
                            onBackPressed();
                        } else {
                            Toast.makeText(getApplicationContext(), "Sửa hóa đơn thất bại", Toast.LENGTH_SHORT).show();
